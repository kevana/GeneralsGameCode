/*
** DirectInput compatibility header for non-Windows platforms.
** Provides DIK_* scan code constants used by KeyDefs.h and the input system.
** These values match the DirectInput keyboard scan codes (PC Keyboard Scan Code Set 1).
*/
...
// These match the PC Keyboard Scan Code Set 1 used by DirectInput
...
#define DIK_NUMPADSTAR      0x37    // AKA DIK_MULTIPLY
#define DIK_MULTIPLY        0x37
#define DIK_LALT            0x38    // AKA DIK_LMENU
#define DIK_LMENU           0x38
#define DIK_SPACE           0x39
#define DIK_CAPSLOCK        0x3A    // AKA DIK_CAPITAL
...
#define DIK_NUMPADMINUS     0x4A    // AKA DIK_SUBTRACT
#define DIK_SUBTRACT        0x4A
#define DIK_NUMPAD4         0x4B
#define DIK_NUMPAD5         0x4C
#define DIK_NUMPAD6         0x4D
#define DIK_NUMPADPLUS      0x4E    // AKA DIK_ADD
#define DIK_ADD             0x4E
#define DIK_NUMPAD1         0x4F
#define DIK_NUMPAD2         0x50
#define DIK_NUMPAD3         0x51
#define DIK_NUMPAD0         0x52
#define DIK_NUMPADPERIOD    0x53    // AKA DIK_DECIMAL
...
#define DIK_PREVTRACK       0x90    // AKA DIK_CIRCUMFLEX
...
#define DIK_NUMPADSLASH     0xB5    // AKA DIK_DIVIDE
#define DIK_DIVIDE          0xB5
#define DIK_SYSRQ           0xB7
#define DIK_RALT            0xB8    // AKA DIK_RMENU
#define DIK_RMENU           0xB8
#define DIK_PAUSE           0xC5
#define DIK_HOME            0xC7
#define DIK_UPARROW         0xC8    // AKA DIK_UP
#define DIK_UP              0xC8
#define DIK_PGUP            0xC9    // AKA DIK_PRIOR
#define DIK_PRIOR           0xC9
#define DIK_LEFTARROW       0xCB    // AKA DIK_LEFT
#define DIK_LEFT            0xCB
#define DIK_RIGHTARROW      0xCD    // AKA DIK_RIGHT
#define DIK_RIGHT           0xCD
#define DIK_END             0xCF
#define DIK_DOWNARROW       0xD0    // AKA DIK_DOWN
#define DIK_DOWN            0xD0
#define DIK_PGDN            0xD1    // AKA DIK_NEXT
...
// DirectInput mouse data offsets
#define DIMOFS_X            0
#define DIMOFS_Y            4
#define DIMOFS_Z            8
